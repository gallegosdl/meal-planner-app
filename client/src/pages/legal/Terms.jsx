  ...
  return (
    <div className="min-h-screen bg-[#252B3B] text-gray-300 p-6">
      <div className="max-w-4xl mx-auto">
        ...
        <p className="mb-6">Welcome to the Meal Planner AI App. By accessing or using this application, you agree to be bound by the following terms and conditions:</p>

        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-white mb-4">1. Usage</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-white mb-4">2. Data</h2>
        ...
        <section className="mb-8">
          <h2 className="text-2xl font-semibold text-white mb-4">4. Changes</h2>
          <p>We may update these terms at any time. Continued use of the application constitutes acceptance of the new terms.</p>
        </section>

        <p className="mt-8">
          If you have questions about these terms, contact: <a href="mailto:support@mealplanner.ai" className="text-blue-400 hover:text-blue-300">support@mealplanner.ai</a>
        </p>
      </div>
    </div>
  );
